...
"
echo -e "\033[31m"
echo -e "\033[32mWHATSAPP : 085147461907\033[0m"
echo -e "\033[31mWEBSITE : https://t.me/Unixpublice"
echo ""

animate_text "ANDA SUDAH TERVERIFIKASI, SILAHKAN MASUKAN LICENSE YANG DI BAGI DARI UNIXXPEDIA"
animate_text "JIKA BELUM PUNYA LICENSE SILAHKAN BELI DI UNIXXPEDIA, UNTUK HARGA 30K FREE UPDATE LICENSE"
animate_text " CONTACT UNIXXPEDIA: "
...
# Menampilkan opsi tanpa animasi
  ...
  echo -e "${BLUE}[+]            ©COPYRIGHT BY UNIXXPEDIA      [+]${NC}"
  echo -e "${BLUE}[+]                                                [+]${NC}"
  echo -e "${BLUE}[+] ============================================== [+]${NC}"
echo ""
 echo -e "${BLUE}[+] ============================================== [+]${NC}"
